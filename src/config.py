...
class ConfigManager:
    ...
    def _set_config(cls):
        ...
        cls.data_config["SCORES_FILE"] = cls.data_config["GAME_DATA_FOLDER"].joinpath(cls.data_config["SCORES_FILE_NAME"])
        cls.data_config["HIGH_SCORE_FILE"] = cls.data_config["GAME_DATA_FOLDER"].joinpath(cls.data_config["HIGH_SCORE_FILE_NAME"])
